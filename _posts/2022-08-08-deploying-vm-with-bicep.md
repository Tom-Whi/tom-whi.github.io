...
I wanted to document an easy entry to using Bicep to deploy something simple without 

Taken from https://docs.microsoft.com/en-us/azure/virtual-machines/windows/quick-create-bicep?tabs=CLI
